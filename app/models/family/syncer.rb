class Family::Syncer
  ...
  private
    def child_syncables
      family.basiq_items.active + family.plaid_items + family.simplefin_items.active + family.lunchflow_items.active + family.enable_banking_items.active + family.accounts.manual
    end
end
